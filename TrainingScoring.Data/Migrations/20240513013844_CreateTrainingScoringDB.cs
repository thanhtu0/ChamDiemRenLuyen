        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    EvaluationFormId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    EvaluationFormCode = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    EvaluationFormName = table.Column<string>(type: "nvarchar(150)", maxLength: 150, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrainingDirectoryName = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxScore = table.Column<int>(type: "int", nullable: false),
                    TypeofScore = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreateAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    TrainingDirectoryId = table.Column<int>(type: "int", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GradeLecturerAssignments", x => new { x.LecturerId, x.GradeId });
                    table.ForeignKey(
                        name: "FK_GradeLecturerAssignments_Grades_GradeId",
                        column: x => x.GradeId,
                        principalTable: "Grades",
                        principalColumn: "GradeId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_GradeLecturerAssignments_Lecturers_LecturerId",
                        column: x => x.LecturerId,
                        principalTable: "Lecturers",
                        principalColumn: "LecturerId");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TrainingDetailId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Order = table.Column<int>(type: "int", nullable: false),
                    TrainingDetailName = table.Column<string>(type: "nvarchar(300)", maxLength: 300, nullable: false),
                    IsProof = table.Column<bool>(type: "bit", nullable: false),
                    MaxScore = table.Column<int>(type: "int", nullable: false),
                    TypeofScore = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreateAt = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GradeLecturerAssignments_GradeId",
